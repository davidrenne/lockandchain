 ...
 * particular, you can set here the values of variables elements defined in lockandchain_lockandchain.tpl (elements
    ...
    protected function getGameName()
    {
  	...
  	{		
        ...
        */
        ...
        $this->page->begin_block( "lockandchain_lockandchain", "myblock" );
